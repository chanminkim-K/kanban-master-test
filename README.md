...
- **React** / **Vue.js** - 모던 UI 프레임워크
- **Modern CSS** - 반응형 디자인 및 최신 UI/UX 트렌드 반영

### Backend
- **Java 17** - 최신 LTS 버전의 Java
- **Spring Boot** - 엔터프라이즈급 애플리케이션 프레임워크
...
│   │   └── test/              # 테스트 코드
│   └── build.gradle / pom.xml # 빌드 설정 파일
│
├── frontend/                   # React/Vue.js 프론트엔드 애플리케이션
│   ├── src/
